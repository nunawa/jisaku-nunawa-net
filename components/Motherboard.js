            ...
            <Stack direction="horizontal">
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  newSelectedProducts.motherboard = iterator;
...
export default function Motherboard({ selectedProducts, setSelected }) {
  ...
  return (
    <>
      <SelectedProduct product={selectedProducts.motherboard} />
