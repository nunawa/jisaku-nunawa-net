...
export function checkMotherboardCaseCompatibility(
  ...
  try {
    const supportedFormFactors = JSON.parse(pcCase.support_motherboard) as string[];
 ...
 */
export function checkAllCompatibility(selectedParts: SelectedParts): CompatibilityIssue[] {
